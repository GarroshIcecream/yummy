...
func New(cookbook *db.CookBook) *ChatModel {
	...
	markdownRenderer, err := glamour.NewTermRenderer(
		...
		glamour.WithWordWrap(ui.ViewportWidth),
	)
	if err != nil {
	...
	ta.SetWidth(ui.TextAreaMaxWidth)
	ta.SetHeight(ui.TextAreaMaxHeight)
	ta.FocusedStyle.CursorLine = lipgloss.NewStyle()
	ta.ShowLineNumbers = false

	vp := viewport.New(ui.ViewportWidth, ui.ViewportHeight)
...
// renderConversationAsMarkdown converts the conversation to a formatted markdown string
